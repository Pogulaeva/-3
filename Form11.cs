    ...
    public partial class OrdersNotConfirmByClientWindow : Form
    {
        ...
        private void ConfirmChangesButton_Click(object sender, EventArgs e)
        {
            if (IDOutput.Text.Length > 0)
            {
                ...
                DataBaseWaitingForConfirm.DataSource = null;
                DataBaseWaitingForConfirm.Rows.Clear();
                DataBaseWaitingForConfirm.Columns.Clear();
        ...
        private void LoadData1()
        {
            using (MySqlConnection connection = new MySqlConnection(connectString))
            {
                ...
                using (MySqlDataAdapter adapter = new MySqlDataAdapter(query, connection))
                {
                    ...
                    DataBaseWaitingForConfirm.DataSource = dataTable;
                }
            }
        }
